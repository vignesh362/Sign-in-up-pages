...
import 'package:signin_main/otp_verify.dart';
...
Future<Otpverify> otpverify(String otp) async {
  final String apiUrl = "https://backend-parkingapp.herokuapp.com/otpVerification";
...
print(response.statusCode);
  if (response.statusCode >300) {
    ...
    return otpverifyFromJson(responseString);
  }
  else  {
    print('********************************************************************');
    print(response.statusCode);
...
Future<Reotpverify> resendotpverify() async {
  ...
  final String apiUrl = "https://backend-parkingapp.herokuapp.com/resendotp";
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () async{
                        ...
                        final  Otpverify user = await otpverify(otp);
